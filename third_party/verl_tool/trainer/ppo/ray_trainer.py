...
class AgentRayPPOTrainer(RayPPOTrainer):
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # evaluate with the same reward routing as training: Level 1
            # trajectory rewards first, single-step reward only as fallback.
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if "score" in batch.non_tensor_batch:
                        score_values = np.asarray(batch.non_tensor_batch["score"], dtype=np.float32)
                        batch.batch["score"] = torch.as_tensor(
                            score_values,
