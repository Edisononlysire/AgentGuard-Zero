"""Current T12 shared environment contracts, retained from the audited v2 suite."""
...
from agentguard_zero.evaluation.rq3_memory import counterfactual_memory_impact, memory_lifecycle_metrics
...
from agentguard_zero.schemas.scenario_schema_v2 import OOD_FAMILIES, minimal_example_v2, paired_counterpart_v2, paired_minimal_examples_v2, public_prefix_hash, validate_pair_v2, validate_scenario_v2
from agentguard_zero.training.vda_dataset import build_vda_prompt, public_instance_id, vda_system_prompt_v4
from agentguard_zero.variants import ACTIVE_PROBE_TOOLS, PASSIVE_VERIFICATION_TOOLS
from agentguard_zero.world.public_projector import assert_public, forbidden_public_paths, project_public
from scripts.eval_tmcd_systems import SYSTEMS, SYSTEM_ALIASES, adapt_packet_v2, default_candidate_count, oracle_action, select_runtime_candidate
