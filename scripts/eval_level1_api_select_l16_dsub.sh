...
export AGZ_SELECTOR_MODE="${AGZ_SELECTOR_MODE:-mitigation_v2}"
...
export AGZ_SELECT_RUN_NAME="${AGZ_SELECT_RUN_NAME:-agentguard_api_select_l16_${BATCH_JOB_ID:-manual}}"
