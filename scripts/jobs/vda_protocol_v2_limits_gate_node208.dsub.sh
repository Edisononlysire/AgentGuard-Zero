...
OUT="${ROOT}/outputs/optimization_gates/vda-delta-wire-v3-gate"
if [[ -e "${OUT}" ]]; then
...
export AGZ_RUN_NAME=agz_gate_qwen3.5-4b_vda_protocol_v2_limits
...
export AGZ_MAX_RESPONSE_LENGTH=12288
