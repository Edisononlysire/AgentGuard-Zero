...
OUT=${ROOT}/outputs/tmcd_v2/gates/vda-append4-partial-b160-node208
DATA=${ROOT}/outputs/tmcd_v2/gates/vda-append4-partial-data
RUN_NAME=agz_gate_qwen3.5-4b_append_partial_vda_batch160_node208

if [[ "$(hostname)" != "cyclone001-agent-208" ]]; then
  echo "Refusing to run outside cyclone001-agent-208: $(hostname)" >&2
  exit 72
fi
