...
DATA_ROOT=${ROOT}/data/tmcd_v24/qwen3.5-9b
CHECKPOINT_ROOT=${ROOT}/checkpoints/tmcd_v24/qwen3.5-9b
...
# The 9B run keeps the previously gated conservative HF configuration.
...
python -s "${ROOT}/scripts/preflight_tmcd_v2_job.py" \
  ...
  --output "${ROOT}/outputs/tmcd_v24/preflight/node217_9b_full.json"
...
touch "${ROOT}/outputs/tmcd_v24/node217_9b_full.SUCCEEDED"
