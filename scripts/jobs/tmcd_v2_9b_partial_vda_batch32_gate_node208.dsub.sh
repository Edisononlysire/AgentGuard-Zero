...
export AGZ_GATE_OUTPUT_DIR="${ROOT}/outputs/tmcd_v2/gates/vda-full9-partial-b32-node208"
...
export AGZ_GATE_RUN_NAME=agz_gate_qwen3.5-9b_partial_vda_batch32_node208
