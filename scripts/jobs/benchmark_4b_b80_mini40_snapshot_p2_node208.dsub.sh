#!/bin/bash
#DSUB -n AGZ4B_B80_M40_SNAPSHOT_P2_GATE
#DSUB -N 1
...
GATE_ROOT="${ROOT}/outputs/optimization_gates/qwen3.5-4b-dca-b80-m40-n2-snapshot-p2"
if [[ -e "${GATE_ROOT}" ]]; then
...
export AGZ_RUN_NAME=agz_gate_qwen3.5-4b_dca_b80_m40_n2_snapshot_p2
...
test "$(wc -l < "${GATE_ROOT}/feedback.jsonl")" -eq 320
echo "4B batch80-mini40 snapshot-p2 gate passed"
