...
OUT="${ROOT}/outputs/optimization_gates/vda-delta-wire-v3-final-gate"
if [[ -e "${OUT}" ]]; then
...
export AGZ_RUN_NAME=agz_gate_qwen3.5-4b_vda_final
...
export AGZ_MAX_ACTION_LENGTH=256
