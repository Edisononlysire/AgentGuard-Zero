...
export AGZ_DCA_PPO_MICRO_BATCH_SIZE_PER_GPU=4
export AGZ_DCA_LOG_PROB_MICRO_BATCH_SIZE_PER_GPU=4
export AGZ_VDA_PPO_MICRO_BATCH_SIZE_PER_GPU=2
...
python -s "${ROOT}/scripts/preflight_tmcd_v2_job.py" \
  ...
  --output "${ROOT}/outputs/tmcd_v2/preflight/node175_4b_full.json"
...
touch "${ROOT}/outputs/tmcd_v2/node175_4b_full.SUCCEEDED"
