...
GATE_ROOT="${ROOT}/outputs/optimization_gates/qwen3.5-4b-dca-b80-n2-flash"
if [[ -e "${GATE_ROOT}" ]]; then
...
export AGZ_RUN_NAME=agz_gate_qwen3.5-4b_dca_b80_n2_flash
...
export AGZ_PPO_MINI_BATCH_SIZE=80
...
echo "4B batch80 FlashAttention gate passed"
