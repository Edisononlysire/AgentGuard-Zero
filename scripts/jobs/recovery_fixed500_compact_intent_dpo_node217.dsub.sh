...
PREFERENCES="$BASE/preferences_bidirectional_core_q"
OUT="$BASE/teacher_sft_compact_intent_3ep_plus_bidirectional_dpo"
EVAL="$BASE/evaluations/teacher_sft_compact_intent_3ep_plus_bidirectional_dpo_quick8"
...
for shard in 0 1 2 3; do
  ...
  TRITON_CACHE_DIR="$cache" CUDA_VISIBLE_DEVICES="${GPU_IDS[$shard]}" python \
    ...
    --variant teacher_sft_compact_intent_3ep_plus_bidirectional_dpo_quick8 \
