...
DATA=${ROOT}/outputs/tmcd_v242/diagnostics/vda1_vs_zero_20260718/data/r1_dev_balanced_80_arrow.parquet
...
sha256sum \
  "${DATA}" \
  "${ROOT}/outputs/tmcd_v242/diagnostics/vda1_vs_zero_20260718/data/manifest_arrow.json" \
