...
GATE_ROOT="${ROOT}/outputs/optimization_gates/qwen3.5-4b-dca-b40-n2-flash"
if [[ -e "${GATE_ROOT}" ]]; then
...
export AGZ_RUN_NAME=agz_gate_qwen3.5-4b_dca_b40_n2_flash
...
echo "4B batch40 FlashAttention gate passed"
