...
MODEL_PATH=${AGZ_MODEL_PATH:-/home/share/huadjyin/home/s_qinhua2/02code/guozhihan/InfectModel/model/Qwen/Qwen3-8B}
...
PY
  python -s "${ROOT}/curriculum_train/scenario_evaluate/build_vda_dataset.py" \
...
PYTHONUNBUFFERED=1 python -s -m verl_tool.trainer.main_ppo \
    ...
    custom_reward_function.path="${ROOT}/curriculum_train/examples/reward_function/vda_reward.py" \
