...
AGZ_QWEN35_TRANSFORMERS_OVERLAY=${AGZ_QWEN35_TRANSFORMERS_OVERLAY:-${AGZ_ROOT}/env_overlays/transformers_qwen35_latest}
AGZ_QWEN35_FLA_OVERLAY=${AGZ_QWEN35_FLA_OVERLAY:-${AGZ_ROOT}/env_overlays/fla_core_py312}
AGZ_QWEN35_CAUSAL_CONV_OVERLAY=${AGZ_QWEN35_CAUSAL_CONV_OVERLAY:-${AGZ_ROOT}/env_overlays/causal_conv1d_v1_6_2_py312_torch26_sm80}
...
export AGZ_QWEN35_4B_PATH=${AGZ_QWEN35_4B_PATH:-${AGZ_ROOT}/models/qwen3_5/Qwen3.5-4B}
export AGZ_QWEN35_9B_PATH=${AGZ_QWEN35_9B_PATH:-${AGZ_ROOT}/models/qwen3_5/Qwen3.5-9B}
