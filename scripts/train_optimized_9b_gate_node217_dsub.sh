...
export AGZ_DCA_FEEDBACK_CANDIDATES=32
export AGZ_DCA_ROLLOUT_N=2
export AGZ_DCA_BATCH_SIZE=16
...
export AGZ_CANDIDATE_BATCH_SIZE=8
export AGZ_PPO_MICRO_BATCH_SIZE_PER_GPU=2
...
/home/share/huadjyin/home/s_qinhua2/01software/miniconda3/envs/agent0-gpu/bin/python -s \
  ...
  --root "${ROOT}" --backbone qwen3.5-9b --artifact-scope pilot --max-round 1
